        ...
        public MixedVegetableMedleyRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    ...
                    {
               new IngredientElement(typeof(CornItem), 12, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)), 
               new IngredientElement(typeof(CamasBulbItem), 12, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)),    
                    },
                    new CraftingElement[]
                    {
