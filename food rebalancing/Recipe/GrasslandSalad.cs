        ...
        public GrasslandSaladRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    ...
                    {
               new IngredientElement(typeof(CornItem), 10, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)), 
               new IngredientElement(typeof(TomatoItem), 12, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)), 
               new IngredientElement(typeof(BeetItem), 10, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)),    
                    },
                    new CraftingElement[]
                    {
